...
var badWordsList = {
  ...
  list: ["anus", "arse", "ass", "asshole", "boob", "ball-bag", "ball-sac", "bastard", "bellend", "biatch", "bitch", "biznatch",
   ...
   "pecker", "penis", "penis fucker", "phone sex dude", "pig fucker", "piss", "pisser", "piss flap", "poooooooooooop", "porn", "porno", "pornography", "prick", "pube", "pussy", "rectum",
    ...
    "barmy", "dodgy berk", "git", "plonker", "prat", "trollop", "twit", "lazy sod", "wazzock", "ninny", "maggot", "bad twerker", "farts-when-twerking-fart-face", "dick-nose", "stinky dick cheese", "flabby boob", "stinky dick wrinkle",
    "sucky twerker", "farm breath", "bad kisser", "flabby butt wrinkle", "dirty toe nail", "stupid head", "chicken neck", "grandma-flabby-face", "turd bucket", "crap napkin", "doo-doo face", "smegma breath", "dumb-dumb", "dried-poopy-butt", "pube face", "donkey foot", "pickle-semen-head",
    "dirt-bag", "french-fry-face", "pickle brain", "dildo face", "dildo breath", "dildo poop head", "condom wrapper", "spludge puddle", "spludge muffin", "dick-sprinkle", "cum icecream cone", "ball sweat breath", "sweaty ball sac", "poop-burger", "dumby-dumb-dumb" ]
